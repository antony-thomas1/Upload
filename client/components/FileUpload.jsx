...
import { useAddress, useContract, useStorageUpload, useContractWrite } from "@thirdweb-dev/react";
        ...
        <div className='flex justify-center items-center gap-[30px]'>
          ...
          <h1 className="font-poppins font-semibold text-[20px] text-white text-left">
            ...
            <div className="flex flex-wrap mt-[20px] gap-[26px]">
              ...
              {!isLoading && contractFiles.length > 0 && contractFiles.map((File) => <FileCard 
                key={File.id}
                {...File}
